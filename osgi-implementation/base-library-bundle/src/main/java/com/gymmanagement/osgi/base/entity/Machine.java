...
/**
 * Machine entity for OSGi Base Library Bundle
...
public class Machine implements Serializable, GymMachine {
    ...
    public Machine(int regId, String name, String brand, String model,
    ...
    public String getAllBookings() {
        ...
        for (int i = 0; i < bookings.length; i++) {
            if (bookings[i] != null) {
                getAllBookingsString += "> " + name + "\t\t" + bookings[i].getName() +
                        " ( " + bookings[i].getRegId() + " )\n";
            }
        }
    ...
    public String toString() {
        return "\n\t\tMachine Details : " + "\n---------------------------------------------------------------\n" +
                ...
                "\n\n> Model : " + model + "\n\n> Maximum Weight Capacity : " + maxWeightCapacity +
