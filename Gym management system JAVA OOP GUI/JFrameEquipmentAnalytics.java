...
public class JFrameEquipmentAnalytics extends javax.swing.JFrame {
    Report report = new Report();
    private String generatedReport;
    private String currentReportType = "EquipmentUsage";
    public JFrameEquipmentAnalytics() {
        initComponents();
    ...
    private void initComponents() {
        ...
        iLabel1.setText("Equipment Usage Analytics");
        ...
        btnAnalyze.setText("Generate Report");
    ...
    private void btnAnalyzeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnalyzeActionPerformed
        generatedReport = report.generateEquipmentUsageAnalyticsReport();
        currentReportType = "EquipmentUsage";
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameEquipmentAnalytics().setVisible(true);
            }
        });
    }
